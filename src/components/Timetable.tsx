...
const Timetable = () => {
    ...
    const renderModal = () => {
        return actualClass && 
        <Modal color={actualClass.color} onClick={() => {toggleModal(undefined)}}>
    ...
    const renderDataCell = (actualClass: Class | undefined, type: string | undefined) => {
        if(type === "first") {
            ...
            return <TD onClick={() => {toggleModal(undefined)}}></TD>
        }
    }
